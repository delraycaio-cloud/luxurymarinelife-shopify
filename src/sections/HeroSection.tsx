...
export function HeroSection() {
  ...
  return (
    <section
      ...
      aria-label="Hero — Health on the Water"
    >
      <div
        ref={bgRef}
      ...
      <div className="relative z-[4] h-full flex items-center pt-24 sm:pt-28 lg:pt-0">
            ...
            >
              ...
              <div className="mt-6 lg:mt-8 flex flex-col sm:flex-row items-center lg:items-start gap-3 justify-center lg:justify-start">
                ...
                <a
                  ...
                  id="hero-ultrashear-cta"
                  aria-label="View UltraShear NanoSpray"
                >
                  View UltraShear™{" "}
