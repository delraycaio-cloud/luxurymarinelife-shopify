...
export const products: Product[] = [
  // APPAREL - Polos & Shirts
  {
    ...
    price: 245,
    image: '/images/product-polo.webp',
    images: ['/images/product-polo.webp'],
    category: 'apparel',
    subcategory: 'polos',
  ...
  },
  {
    ...
    price: 685,
    image: '/images/product-sweater.webp',
    images: ['/images/product-sweater.webp'],
    category: 'apparel',
  ...
  },
  {
    ...
    price: 1250,
    image: '/images/product-blazer.webp',
    images: ['/images/product-blazer.webp'],
    category: 'apparel',
    subcategory: 'blazers',
  ...
  // FOOTWEAR
  {
    ...
    price: 295,
    image: '/images/product-shoes.webp',
    images: ['/images/product-shoes.webp'],
    category: 'footwear',
  ...
  },
  {
    ...
    price: 185,
    image: '/images/product-scarf.webp',
  ...
  },
  {
    ...
    images: ['/images/product-cap.webp'],
    category: 'accessories',
  ...
  },
  {
    ...
    price: 345,
    image: '/images/product-cufflinks.webp',
    images: ['/images/product-cufflinks.webp'],
    category: 'accessories',
    subcategory: 'jewelry',
    collection: 'The Commodore Line',
    sizes: ['One Size'],
...
export const lookbookItems: LookbookItem[] = [
  ...
  {
    id: '3',
    image: '/images/social-gathering.webp',
